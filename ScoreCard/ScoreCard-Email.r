...
writeFile <- paste("V:/Shared Documents/ScoreCard/Report/ScoreCard-",format(Sys.Date(),'%Y'),"Departures-",as.Date(Sys.Date(),format='%Y%m%d'),".xlsx",sep="")
...
writeData(wb.master,3,data.digitalSpend)
sheetVisibility(wb.master)[3] <- FALSE
writeFile <- paste("V:/Shared Documents/ScoreCard/Report/ScoreCard-",format(Sys.Date()+365,'%Y'),"Departures-",as.Date(Sys.Date(),format='%Y%m%d'),".xlsx",sep="")
saveWorkbook(wb.master,file=writeFile,overwrite=TRUE)
